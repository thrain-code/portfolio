  ...
  return (
    <div className="w-full">
      ...
      <div className="text-zinc-300 lg:text-lg text-sm px-4">
        ...
        {activeTab === "mindset" && (
          <p>
            As a developer, I have never believed in talent. Talent is just luck
            granted to those who don’t even have to try. Meanwhile, I have to
            struggle, sacrifice my time, energy, and mind just to reach the same
            point as them. I hate seeing people who can easily master something
            without having to go through a long and painful process. I hate
            seeing them sitting comfortably while I have to fight through every
            line of code, every error that crushes my mental state, and every
            failure that feels like a hard blow to the head. But that hatred is
            not a weakness—it is fuel. I let it drive me, burn me from within,
            and force me to move forward. If I don’t have talent, then I will
            replace it with unmatched hard work. If I don’t have a natural
            advantage, then I will carve it out with blood and sweat. I will
            learn, try, fail, and rise again until I can stand at the top and
            look down—at those who only rely on luck without effort. I will not
            accept defeat, and I will not let those who are lazy and complacent
            surpass me. If the world is unfair, then I will force justice with
            my own hands.
          </p>
        )}
      </div>
